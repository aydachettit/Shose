...
namespace Shoes.GUI
{
    public partial class Form1 : Form
    {
        ...
        private void btnThemHoaDon_Click(object sender, EventArgs e)
        {
            ...
            DateTime dt = DateTime.ParseExact(dateReceipt.Text, "M/dd/yyyy", CultureInfo.InvariantCulture);
            ...
            else
            {
                ...
                btnReset.Enabled = true;
                HoaDonDTO hdmoi = new HoaDonDTO(txtMaHoaDon.Text, cboMaKhachHang.Text, cboMaNhanVien.Text, DateTime.Parse(dateReceipt.Text), 0);
        ...
        private void btnThemSanPham_Click(object sender, EventArgs e)
        {
            ...
            if (txtTongCong.Text != "")
            {
               tong = Int32.Parse(txtTongCong.Text);
            }
            else
            {
                tong = 0;
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:F1"].Value = labelBangChu.Text;
        ...
        private void btnSuaSanPham_Click(object sender, EventArgs e)
        {
            ...
            if(cboMaSanPham.Text != "" && txtSoLuong.Text != "" && txtMaHoaDon.Text != "")
            {
                if (MessageBox.Show("Bạn chắc chắn muốn sửa sản phẩm này?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    {
                        MessageBox.Show("Sản phẩm này không tồn tại trong hóa đơn này!");
                    }
        ...
        private void btnSuaHoaDon_Click(object sender, EventArgs e)
        {
            ...
            {
                HoaDonDTO hd = new HoaDonDTO(txtMaHoaDon.Text, cboMaKhachHang.Text, cboMaNhanVien.Text, DateTime.Parse(dateReceipt.Text), float.Parse(txtTongCong.Text));
